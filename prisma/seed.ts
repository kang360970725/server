...
async function main() {
    ...
    const permissions: Array<{
        ...
        { key: 'menu:staff', name: '服务者中心', module: 'menu', type: PermissionType.PAGE },
        { key: 'menu:workbench', name: '服务者在线看板', module: 'menu', type: PermissionType.PAGE },
        ...
        { key: 'menu:staff-ratings', name: '服务者评级', module: 'menu', type: PermissionType.PAGE },
        ...
        { key: 'miniapp:customer-service:page', name: '客服二维码配置', module: 'miniapp', type: PermissionType.PAGE, parentKey: 'menu:miniapp-config' },
        ...
        { key: 'orders:workbench:page', name: '服务者在线看板兼容权限', module: 'orders', type: PermissionType.PAGE, parentKey: 'menu:workbench' },
        { key: 'service:online-board:page', name: '服务者在线看板', module: 'service', type: PermissionType.PAGE, parentKey: 'menu:workbench' },
        ...
        { key: 'orders:workbench:create:button', name: '服务者在线看板快捷发单', module: 'orders', type: PermissionType.BUTTON, parentKey: 'service:online-board:page' },
        ...
        { key: 'menu:membership', name: '会员体系', module: 'menu', type: PermissionType.PAGE },
        { key: 'wallet:member-levels:page', name: '会员等级', module: 'wallet', type: PermissionType.PAGE, parentKey: 'menu:membership' },
        { key: 'wallet:member-benefits:page', name: '会员权益', module: 'member', type: PermissionType.PAGE, parentKey: 'menu:membership' },
        { key: 'wallet:recharge-plans:page', name: '充值方案', module: 'wallet', type: PermissionType.PAGE, parentKey: 'menu:membership' },
        { key: 'wallet:member-recharges:page', name: '会员充值记录', module: 'wallet', type: PermissionType.PAGE, parentKey: 'menu:membership' },
        { key: 'wallet:transactions:page', name: '流水明细', module: 'wallet', type: PermissionType.PAGE, parentKey: 'menu:wallet' },
        { key: 'wallet:deposit-reconciliation:page', name: '保证金对账', module: 'wallet', type: PermissionType.PAGE, parentKey: 'menu:wallet' },
        ...
        { key: 'users:member:page', name: '会员管理', module: 'users', type: PermissionType.PAGE, parentKey: 'menu:membership' },
        ...
        { key: 'users:staff:assign-role:button', name: '服务者分配角色', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        { key: 'users:staff:change-level:button', name: '服务者升降级', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        { key: 'users:staff:reset-password:button', name: '重置服务者密码', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        { key: 'users:staff:delete:button', name: '删除服务者', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        { key: 'users:staff:exit:button', name: '服务者退出平台', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        ...
        { key: 'users:staff:leave-reject:button', name: '驳回服务者请假', module: 'users', type: PermissionType.BUTTON, parentKey: 'users:staff:page' },
        ...
        { key: 'staff-ratings:page', name: '服务者评级', module: 'staff-ratings', type: PermissionType.PAGE, parentKey: 'menu:staff-ratings' },
    ...
    const financePermissionKeys = [
        ...
        'wallet:deposit-reconciliation:page',
