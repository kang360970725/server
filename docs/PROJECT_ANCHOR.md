...
为避免“锚点文档与实际代码漂移”，已新增代码事实快照：

- `docs/CODEBASE_SNAPSHOT_2026-04-10.md`

该快照补充了以下已落地但旧锚点未完整描述的内容：

- 钱包/提现完整链路（含限制规则）
- 财务报表与业绩看板模型及接口
- 全局 Guard 执行顺序与冻结用户访问策略
- `system-admin` 与 `server` 的当前联调事实
- 前端历史接口残留与后端现行接口差异

---
## 十、审计日志 Action 规范（必须同步 /meta/enums）
