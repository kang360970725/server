...
export class UsersController {
  ...
  findAll(
      ...
      @Query('wechatBoundOnly') wechatBoundOnly?: string,
      @Query('memberState') memberState?: string,
      @Query('memberLevelCode') memberLevelCode?: string,
    ...
    return this.usersService.findAll({
      ...
      wechatBoundOnly,
      memberState,
      memberLevelCode: memberLevelCode || memberLevel,
      loginInactiveDays,
      acceptInactiveDays,
      scene,
      actor: req?.user,
