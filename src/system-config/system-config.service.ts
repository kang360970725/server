...
export class SystemConfigService implements OnModuleInit {
  ...
  static readonly KEYS = {
    ...
    WITHDRAW_AUTO_SINGLE_LIMIT: 'withdraw_auto_single_limit',
    WITHDRAW_AUTO_FIRST_LIMIT: 'withdraw_auto_first_limit',
    WITHDRAW_AUTO_USER_DAY_LIMIT: 'withdraw_auto_user_day_limit',
    WITHDRAW_AUTO_USER_MONTH_LIMIT: 'withdraw_auto_user_month_limit',
    WITHDRAW_AUTO_PLATFORM_DAY_LIMIT: 'withdraw_auto_platform_day_limit',
    WITHDRAW_AUTO_ELIGIBILITY: 'withdraw_auto_eligibility',
    WECHAT_TRANSFER_SCENE_ID: 'wechat_transfer_scene_id',
    WECHAT_TRANSFER_NOTIFY_URL: 'wechat_transfer_notify_url',
    WECHAT_TRANSFER_APPID: 'wechat_transfer_appid',
    WECHAT_TRANSFER_APPSECRET: 'wechat_transfer_appsecret',
  ...
  async ensureDefaults() {
    const defaults = [
      ...
      {
        key: SystemConfigService.KEYS.WITHDRAW_WECHAT_TRANSFER_ENABLED,
        value: 'false',
        valueType: 'BOOLEAN',
        remark: '微信商家转账通道开关',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_WECHAT_TRANSFER_MOCK,
        value: String(process.env.WECHAT_TRANSFER_MOCK || '').trim() === '1' ? 'true' : 'false',
        valueType: 'BOOLEAN',
        remark: '微信商家转账测试模式：不请求微信，直接模拟受理成功',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_SINGLE_LIMIT,
        value: '2000',
        valueType: 'NUMBER',
        remark: '提现自动打款单笔上限',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_FIRST_LIMIT,
        value: '1000',
        valueType: 'NUMBER',
        remark: '新人首次提现自动打款上限',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_USER_DAY_LIMIT,
        value: '5000',
        valueType: 'NUMBER',
        remark: '单人每日自动打款上限',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_USER_MONTH_LIMIT,
        value: '15000',
        valueType: 'NUMBER',
        remark: '单人每月自动打款上限',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_PLATFORM_DAY_LIMIT,
        value: '50000',
        valueType: 'NUMBER',
        remark: '平台每日自动打款总额上限',
      },
      {
        key: SystemConfigService.KEYS.WITHDRAW_AUTO_ELIGIBILITY,
        value: JSON.stringify({
          mode: 'WHITELIST',
          userIds: [],
          staffRuleGroups: [],
      ...
      {
        key: SystemConfigService.KEYS.WECHAT_TRANSFER_SCENE_ID,
        value: String(process.env.WECHAT_TRANSFER_SCENE_ID || '').trim(),
        valueType: 'STRING',
        remark: '微信商家转账场景ID',
      },
      {
        key: SystemConfigService.KEYS.WECHAT_TRANSFER_NOTIFY_URL,
        value: String(process.env.WECHAT_TRANSFER_NOTIFY_URL || '').trim(),
        valueType: 'STRING',
        remark: '微信商家转账回调地址',
      },
      {
        key: SystemConfigService.KEYS.WECHAT_TRANSFER_APPID,
        value: String(process.env.WECHAT_TRANSFER_APPID || '').trim(),
        valueType: 'STRING',
        remark: '微信商家转账收款 openid 所属 AppID；H5 绑定时通常填公众号 AppID，空则回退小程序 AppID',
      },
      {
        key: SystemConfigService.KEYS.WECHAT_TRANSFER_APPSECRET,
        value: String(process.env.WECHAT_TRANSFER_APPSECRET || '').trim(),
        valueType: 'STRING',
        remark: '微信商家转账 AppID 对应 AppSecret；H5 微信网页授权绑定使用',
      },
      {
